...
public class FloatTest {
    static void testFloat(){
        float result, varFirst = 50.2f, varSecond = 20.31F;
        ...
        System.out.println("\n *Bitwise Operators*");
        System.out.println("\n Such operators are wrong for FLOAT \n");
...
//        System.out.printf("%f >>>= 1 --> c = %f\n", result, result >>>= 1);
        ...
        result = (float) d;
        System.out.printf("int = double: c = (float)%f --> c = %f\n", d, result);
        // c = (int)bool;
        System.out.printf("in  = boolean: c = (float)%b --> Compile Error\n", bool);
    }
}
